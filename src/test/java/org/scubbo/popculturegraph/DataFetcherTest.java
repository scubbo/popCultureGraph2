...
public class DataFetcherTest {
    ...
    /**
     * I've been lazy here, and haven't unit-tested the actual operation of
     * the DataFetcher. Cos, honestly, can't be arsed.
     *
     * If any kind souls want to submit tests, then please be my guest!
     *
     * Still needs tests to:
     *  - confirm that response is written to database
     *  - confirm that stale data is abandoned
     *  (I could make that easier by extracting the parsing logic and
     *  having the DataFetcher just orchestrate between
     *  databaseConnector, jsoup doc, and parser)
     */
